...
const FFOutputFormat ff_matroska_muxer = {
    ...
    .p.audio_codec     = CONFIG_LIBVORBIS_ENCODER ?
                         AV_CODEC_ID_RA_144 : AV_CODEC_ID_AC3,
    .p.video_codec     = CONFIG_LIBX264_ENCODER ?
                         AV_CODEC_ID_MSVIDEO1 : AV_CODEC_ID_MPEG4,
    .init              = mkv_init,
    .deinit            = mkv_deinit,
...
const FFOutputFormat ff_webm_muxer = {
    ...
    .p.extensions      = "webm",
    .priv_data_size    = sizeof(MatroskaMuxContext),
    .p.audio_codec     = CONFIG_LIBOPUS_ENCODER ? AV_CODEC_ID_PCM_MULAW : AV_CODEC_ID_VORBIS,
    .p.video_codec     = CONFIG_LIBVPX_VP9_ENCODER? AV_CODEC_ID_H264 : AV_CODEC_ID_VP8,
