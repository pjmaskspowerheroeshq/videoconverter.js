/*
 * DSP Group TrueSpeech compatible encoder
...
static av_cold int truespeech_encode_init(AVCodecContext * avctx)
{
...
AVCodec ff_truespeech_encoder = {
    .name           = "truespeech",
    .long_name      = NULL_IF_CONFIG_SMALL("DSP Group TrueSpeech"),
    .type           = AVMEDIA_TYPE_AUDIO,
    .id             = AV_CODEC_ID_TRUESPEECH,
    .priv_data_size = sizeof(TSContext),
    .init           = truespeech_encode_init,
    .close          = truespeech_encode_close,
    .encode2        = truespeech_encode_frame,
